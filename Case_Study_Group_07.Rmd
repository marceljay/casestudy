...
Every TidyTXT function has to insert line breakers following a predetermined row pattern. After defining the line breakers the function imports each file using the read.table function. The resulting data frame is then transformed into a tidy data frame. Each function is shown below: 
