...
component_K7 <- read_delim("./Data/Logistikverzug/Logistikverzug_K7.csv", delim = ";")
...
component_K7$Wareneingang <- as.Date(component_K7$Wareneingang, format = "%d.%m.%Y")
```

Creating Data Set "Logistics Delay"
```{r}
#Logistics_Delay$delay <- logistic_delay_K7$Wareneingang - component_K7$Wareneingang
