...
It makes sense to store available data in seperate files instead of saving everything in a huge table for several reasons. Sepa-rate data sets connected by a primary key will only contain specific information ensuring data dependencies make sense. Thus extraction from specific data will be easier. Furthermore duplicate data throughout can be easier identified and eliminated, enhancing the efficiency of the code and saving memory space/cache.Furthermore the different tables will be more flexible for adaptations and newly introduced data. 
